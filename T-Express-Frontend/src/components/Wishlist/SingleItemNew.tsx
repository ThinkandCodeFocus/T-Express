...
const SingleItemNew = ({ item, onRemove }: SingleItemProps) => {
    ...
    <div className="flex items-center border-t border-gray-3 py-5 px-10">
          ...
          <div className="w-full flex items-center gap-5.5">
            ...
            <div>
              <h3 className="text-dark ease-out duration-200 hover:text-blue">
                <a href={`/shop-details?id=${item.id}`}> {item.title} </a>
              </h3>
            </div>
          </div>
        </div>
      ...
      <div className="min-w-[205px]">
        <div className="flex flex-col">
          {item.discountedPrice < item.regularPrice ? (
            <>
              <p className="text-dark font-medium">{formatPrice(item.discountedPrice)}</p>
              <p className="text-gray-5 text-sm line-through">{formatPrice(item.regularPrice)}</p>
            </>
          ) : (
            <p className="text-dark font-medium">{formatPrice(item.regularPrice)}</p>
          )}
        </div>
      </div>
          ...
          <div className="flex items-center gap-1.5">
            ...
            >
              <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M10 18.9583C5.05247 18.9583 1.04169 14.9476 1.04169 10C1.04169 5.05247 5.05247 1.04169 10 1.04169C14.9476 1.04169 18.9584 5.05247 18.9584 10C18.9584 14.9476 14.9476 18.9583 10 18.9583ZM13.5893 8.33932C13.8578 8.07083 13.8578 7.63553 13.5893 7.36705C13.3208 7.09856 12.8855 7.09856 12.617 7.36705L8.75002 11.234L7.38299 9.86698C7.1145 9.59849 6.67921 9.59849 6.41072 9.86698C6.14223 10.1355 6.14223 10.5708 6.41072 10.8392L8.26405 12.6926C8.53254 12.9611 8.9678 12.9611 9.23629 12.6926L13.5893 8.33932Z"
                fill="#22C55E"
              />
            </svg>
            <span className="text-green"> En stock ({item.stock}) </span>
          </div>
        ) : (
          <div className="flex items-center gap-1.5">
            <svg
      ...
      <div className="min-w-[150px] flex justify-end">
        <button
          ...
          className={`inline-flex text-dark bg-gray-1 border border-gray-3 py-2.5 px-6 rounded-md ease-out duration-200 ${
            item.inStock 
              ? 'hover:text-white hover:bg-blue hover:border-gray-3 cursor-pointer' 
