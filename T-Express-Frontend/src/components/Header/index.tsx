...
const Header = () => {
  ...
  const totalPrice = panier?.total || 0;
              ...
              <div className="flex items-center gap-5">
                {isAuthenticated && user ? (
                  <div className="relative">
                    ...
                    {userDropdownOpen && (
                      <ul className="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg border border-gray-3 z-50">
                        <li>
                          <Link
                        ...
                        <li>
                          <button
                            className="block w-full text-left px-4 py-2 text-sm text-dark hover:bg-gray-1"
                            onClick={() => {
                              setUserDropdownOpen(false);
                              logout();
                            }}
